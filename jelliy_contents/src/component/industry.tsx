  ...
  return (
    <div className="component_container">
      ...
      <section className='first_view industry' ref={firstViewRef} style={sectionStyle(0)}>
        <h1 className='art_h1'>産業<br />技術</h1>
        ...
        <div className='merit_and_demerit_block scroller_decoration'>
          <article className={`merit ${animateMerit ? 'animate' : ''}`}>
            <h2>特長</h2>
            <h3>効率向上と生産性の向上</h3><p>産業技術は生産プロセスを自動化し、作業の効率向上に寄与しています。これにより、製品やサービスの生産性が向上し、企業は競争力を維持できます。</p>
            <h3>新しい製品とサービスの開発</h3><p>産業技術は革新的な製品やサービスの創造を可能にします。新しい技術の導入により、市場において新たな需要が生まれ、企業は競争の中で差別化を図ることができます。</p>
            <h3>グローバルな連携と情報共有</h3><p>産業技術は世界中の企業や研究機関との連携を促進し、情報の迅速な共有が可能となります。国際的なイノベーションが進み、異なる地域や国々が共同で問題解決に取り組むことができます。</p>
            <h3>人間の労働負担の軽減</h3><p>自動化やロボット技術の進歩により、危険な作業や単調な業務を機械が担当することが可能となり、人間の労働負担が軽減されます。労働者はより高度なスキルを身につける機会が増えます</p>
          </article>
          <article className={`demerit ${animateDemerit ? 'animate' : ''}`}>
            <h2>難点</h2>
            <h3>雇用の不安定性と職業の転換</h3><p>自動化やロボット化が進む中、一部の労働者は仕事を失う可能性があります。新たな技術の導入により、一部の職種が減少する一方で、新しい職種が生まれるため、雇用の不安定性が生じることがあります。</p>
            <h3>技術格差とデジタルディバイド</h3><p>産業技術の導入には高度な技術スキルが必要となりますが、これが十分に身についていない人々にとっては技術格差が広がる可能性があります。また、デジタルデバイドにより、一部の地域や社会階層が情報へのアクセスに差が生まれることも懸念されます。</p>
            <h3>プライバシーの懸念とデータセキュリティ</h3><p>産業技術の発展に伴い、大量のデータが生成されます。これにより、個人のプライバシーが侵害される懸念が生まれる一方で、データのセキュリティが脅かされる可能性もあります。企業や組織はこれらの課題に対処するために十分な対策を講じる必要があります。</p>
            <h3>環境への影響と資源の枯渇</h3><p>一部の産業技術は資源の大量消費を伴い、それが環境への悪影響をもたらすことがあります。レアアースなどの希少資源の採掘や使用には環境への負荷が高まり、持続可能な開発の観点から検討が必要です。</p>
            <h3>倫理的な問題と法規制の課題</h3><p>産業技術の進化には倫理的な問題が絡むことがあります。例えば、人工知能や生命工学などの分野では、個人や社会全体に対する影響が深刻であり、それに対する適切な法規制や倫理規範が必要です。</p>
          </article>
        </div>
